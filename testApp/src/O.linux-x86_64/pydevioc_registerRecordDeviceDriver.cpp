...
/* Generated from ../O.Common/pydevioc.dbd */
...
epicsShareExtern typed_rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    ...
    *pvar_rset_printfRSET, *pvar_rset_pycalcRSET, *pvar_rset_selRSET,
...
epicsShareExtern rso_func pvar_func_aSubRecordSizeOffset,
    ...
    pvar_func_printfRecordSizeOffset, pvar_func_pycalcRecordSizeOffset,
...
static const char * const recordTypeNames[] = {
    ...
    "mbbiDirect", "mbbo", "mbboDirect", "permissive", "printf", "pycalc",
...
static const recordTypeLocation rtl[] = {
    ...
    {(struct typed_rset *)pvar_rset_pycalcRSET, pvar_func_pycalcRecordSizeOffset},
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_devPyDevAi,
    ...
    *pvar_dset_devAoSoftCallback, *pvar_dset_devPyDevAo,
    ...
    *pvar_dset_devPyDevBi, *pvar_dset_asynBiInt32,
    ...
    *pvar_dset_devPyDevBo, *pvar_dset_asynBoInt32,
    ...
    *pvar_dset_devPyDevMbbi, *pvar_dset_asynMbbiInt32,
    ...
    *pvar_dset_devPyDevMbbo, *pvar_dset_asynMbboInt32,
    ...
    *pvar_dset_devPyDevStringin, *pvar_dset_asynSiOctetCmdResponse,
    *pvar_dset_asynSiOctetWriteRead, *pvar_dset_asynSiOctetRead,
    *pvar_dset_devSoSoft, *pvar_dset_devSoSoftCallback,
    *pvar_dset_devSoStdio, *pvar_dset_devPyDevStringout,
    *pvar_dset_asynSoOctetWrite, *pvar_dset_devSASoft,
    *pvar_dset_devWfSoft, *pvar_dset_devPyDevWaveform,
...
static const char * const deviceSupportNames[] = {
    ...
    "devPyDevAi", "asynAiInt32", "asynAiInt32Average", "asynAiFloat64",
    "asynAiFloat64Average", "asynAiInt64", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "devPyDevAo", "asynAoInt32", "asynAoFloat64",
    "asynAoInt64", "asynRecordDevice", "devBiSoft", "devBiSoftRaw",
    "devBiSoftCallback", "devBiDbState", "devPyDevBi", "asynBiInt32",
    "asynBiUInt32Digital", "devBoSoft", "devBoSoftRaw",
    "devBoSoftCallback", "devBoGeneralTime", "devBoDbState", "devPyDevBo",
    ...
    "devLiSoftCallback", "devLiGeneralTime", "devPyDevLongin",
    "asynLiInt32", "asynLiUInt32Digital", "asynLiInt64", "devLoSoft",
    "devLoSoftCallback", "devPyDevLongout", "asynLoInt32",
    "asynLoUInt32Digital", "asynLoInt64", "devLsiSoft", "devLsiEnviron",
    ...
    "devMbbiSoftCallback", "devPyDevMbbi", "asynMbbiInt32",
    ...
    "devPyDevMbbo", "asynMbboInt32", "asynMbboUInt32Digital",
    ...
    "devPyDevStringin", "asynSiOctetCmdResponse", "asynSiOctetWriteRead",
    "asynSiOctetRead", "devSoSoft", "devSoSoftCallback", "devSoStdio",
    "devPyDevStringout", "asynSoOctetWrite", "devSASoft", "devWfSoft",
    "devPyDevWaveform", "asynWfOctetCmdResponse", "asynWfOctetWriteRead",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devPyDevAi, pvar_dset_asynAiInt32,
    ...
    pvar_dset_devBiDbState, pvar_dset_devPyDevBi, pvar_dset_asynBiInt32,
    pvar_dset_asynBiUInt32Digital, pvar_dset_devBoSoft,
    pvar_dset_devBoSoftRaw, pvar_dset_devBoSoftCallback,
    pvar_dset_devBoGeneralTime, pvar_dset_devBoDbState,
    pvar_dset_devPyDevBo, pvar_dset_asynBoInt32,
    ...
    pvar_dset_devPyDevWaveform, pvar_dset_asynWfOctetCmdResponse,
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_drvAsynSerialPortRegisterCommands, pvar_func_pydevRegister,
...
int pydevioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/pla/modules/pydevice";
...
/* pydevioc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"pydevioc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(pydevioc_registerRecordDeviceDriver(*iocshPpdbbase));
}
